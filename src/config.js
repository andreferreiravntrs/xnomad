...
const postalCode = '11143';
const streetAddress = 'Kungsgatan 8';

// Canonical root url is needed in social media sharing and SEO optimization purposes.
const canonicalRootURL = process.env.REACT_APP_CANONICAL_ROOT_URL;

// Site title is needed in meta tags (bots and social media sharing reads those)
const siteTitle = 'xNomad';

// Twitter handle is needed in meta tags (twitter:site). Start it with '@' character
const siteTwitterHandle = '@xNomad1';

// Instagram page is used in SEO schema (http://schema.org/Organization)
const siteInstagramPage = 'https://www.instagram.com/xnomad.co/';

// Facebook page is used in SEO schema (http://schema.org/Organization)
const siteFacebookPage = 'https://www.facebook.com/xnomad.co/';
...
const hubSpot = {
  ...
  getStartedFormId: process.env.REACT_APP_HUBSPOT_GET_STARTED_FORM_ID,
  fashionFormId: process.env.REACT_APP_HUBSPOT_FASHION_FORM_ID,
  ecommerceFormId: process.env.REACT_APP_HUBSPOT_FASHION_FORM_ID,
  agencyFormId: process.env.REACT_APP_HUBSPOT_AGENCY_FORM_ID,
  buzzFormId: process.env.REACT_APP_HUBSPOT_BUZZ_FORM_ID,
};
