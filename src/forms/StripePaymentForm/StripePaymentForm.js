  ...
  fonts: [
    {
      ...
      src:
        'local("montserrat"), local("Montserrat"), url("https://fonts.gstatic.com/s/montserrat/v13/JTURjIg1_i6t8kCHKm45_ZpC3gnD_g.woff2") format("woff2")',
    },
  ],
};
  ...
  paymentForm(formRenderProps) {
    ...
    return hasStripeKey ? (
      <Form className={classes} onSubmit={handleSubmit}>
        ...
        <p className={css.acceptTerms}>
          <NamedLink name="TermsOfServicePage" className={css.legalLink}>
            <FormattedMessage id="StripePaymentForm.acceptTerms" />
          </NamedLink>
        </p>
