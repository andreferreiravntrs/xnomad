...
import css from './AreaFilterForm.css';
...
const AreaFilterFormComponent = props => {
  ...
  if (liveEdit && !onChange) {
    throw new Error('AreaFilterForm: if liveEdit is true you need to provide onChange function');
  }

  if (!liveEdit && !(onCancel && onClear && onSubmit)) {
    throw new Error(
      'AreaFilterForm: if liveEdit is false you need to provide onCancel, onClear, and onSubmit functions'
    );
  }
