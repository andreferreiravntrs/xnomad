...
const tabCompleted = (tab, listing) => {
  ...
  switch (tab) {
    ...
    case PRICING:
      return !!(price && publicData && publicData.dynamicPricing && publicData.dynamicPricing.priceLess7Days && publicData.dynamicPricing.priceMore7Days && publicData.dynamicPricing.priceMore30Days) ;
    case AVAILABILITY:
