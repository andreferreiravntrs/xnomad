...
const initialAreaRangeValue = (queryParams, paramName) => {
  const area = queryParams[paramName];
...
const SearchFiltersComponent = props => {
  ...
  const initialAreaRange = areaFilter
    ? initialAreaRangeValue(urlQueryParams, areaFilter.paramName)
    : null;
